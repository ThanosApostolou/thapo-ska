...
use super::do_update_chat;

pub async fn handle_update_chat(
    ...
    tracing::trace!("handle_update_chat start query={}", &query_json);

    let create_chat_result = do_update_chat(&global_state, user_details, body).await;
