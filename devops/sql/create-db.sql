...
CREATE SCHEMA IF NOT EXISTS thapo_ska_schema;
GRANT ALL PRIVILEGES ON DATABASE thapo_ska_db_local to example_user;
GRANT ALL PRIVILEGES ON SCHEMA thapo_ska_schema to example_user;
...
CREATE SCHEMA IF NOT EXISTS thapo_skakeycloak_schema;
GRANT ALL PRIVILEGES ON DATABASE thapo_skakeycloak_db_local to example_keycloak_user;
GRANT ALL PRIVILEGES ON SCHEMA thapo_skakeycloak_schema to example_keycloak_user;
